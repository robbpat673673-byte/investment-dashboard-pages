...
describe("buildPublicFundDetail", () => {
  it("回傳完整歷史、五期比較與國內基金來源契約", () => {
    const detail = buildPublicFundDetail({ id: 7, name: "測試國內基金", code: "TEST07", fundType: "domestic", currency: "TWD", latestNav: 15, asOfDate: "2026-08-14", history, lastSyncedAt: "2026-08-15" });
