...
type RefreshEvent = { type: "started" | "stage-start" | "stage-progress" | "stage-complete" | "complete"; stage?: StageKey; completed?: number; total?: number; updated?: number; result?: RefreshResult; error?: string };
...
export function ManualRefreshPanel({ onCompleted }: { onCompleted: () => void }) {
  ...
  const startRefresh = () => {
    ...
    const source = new EventSource("/api/admin/refresh/stream");
